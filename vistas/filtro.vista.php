    ...
    <div class="container">
         <nav class="navbar navbar-expand-lg navbar-light bg-light">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <form name="rangoprecio" class="form-inline my-2 my-lg-0" action="<?php echo RUTA ;?>filtro.php" method="get">
                    <input class="form-control mr-sm-2" name="precioMinimo" type="search" placeholder="Precio Minimo" value="<?php echo $precioMinimo?>" aria-label="Search">
                    <input class="form-control mr-sm-2" name="precioMaximo" type="search" placeholder="Precio Maximo" value="<?php echo $precioMaximo?>" aria-label="Search">
                ...
                <br>
                    <div class="card" style="width: 18rem;margin-left: auto; margin-right: auto;">
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text">Precio Aproximado $<?php echo $post['precio'];?><p>
                            <div >
